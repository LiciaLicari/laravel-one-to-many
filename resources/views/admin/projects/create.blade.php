            ...
            <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- <div class="mb-5">
                   ...
                   is-invalid @enderror placeholder=""
                        aria-describedby="helpId">
                    <small id="githubHelper" class="text-muted">Insert a github link</small>
                    @error('github')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="link" id="link" class="form-control"
                        @error('link')   
                   is-invalid @enderror placeholder="" aria-describedby="helpId">
                    <small id="linkHelper" class="text-muted">Insert a link</small>
                    @error('link')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div> --}}
                <div class="mb-3">
                    <label for="github" class="form-label"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                ...
                <div class="mb-3">
                    <label for="link" class="form-label"><svg xmlns="http://www.w3.org/2000/svg" height="1.2em"
                    ...
                    <div class="form-text" id="basic-addon4">Insert your link</div>
                </div>
